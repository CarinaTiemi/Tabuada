package br.com.carinatiemiyoshida.timestable;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void generateTimesTable(int timesTable){
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,timesTableContent);
